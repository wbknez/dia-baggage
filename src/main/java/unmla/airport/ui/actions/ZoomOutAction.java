 ...
 * 
 */
public class ZoomOutAction extends AbstractSimulationAction {
    ...
    public ZoomOutAction(final SimulationController controller) {
        super("Zoom Out", controller);
        ...
        this.putValue(Action.LARGE_ICON_KEY, 
                this.loadIcon("/data/icons/zoom_out.png", null));
        this.putValue(Action.SHORT_DESCRIPTION, "Zoom out.");
        this.putValue(Action.SMALL_ICON, 
                this.loadIcon("/data/icons/zoom_outSmall.png", null));
    }
